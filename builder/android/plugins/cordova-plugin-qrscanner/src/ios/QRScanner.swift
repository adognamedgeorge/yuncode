...
class QRScanner : CDVPlugin, AVCaptureMetadataOutputObjectsDelegate {
    ...
    func prepScanner(command: CDVInvokedUrlCommand) -> Bool{
        ...
        do {
            if (captureSession?.isRunning != true){
                ...
                metaOutput!.metadataObjectTypes = [AVMetadataObjectTypeQRCode, AVMetadataObjectTypeCode39Code, AVMetadataObjectTypeCode93Code,
                    AVMetadataObjectTypeCode128Code, AVMetadataObjectTypeDataMatrixCode, AVMetadataObjectTypeEAN8Code, AVMetadataObjectTypeEAN13Code]
    ...
    func captureOutput(_ captureOutput: AVCaptureOutput!, didOutputMetadataObjects metadataObjects: [Any]!, from connection: AVCaptureConnection!) {
        ...
        if (found.type == AVMetadataObjectTypeQRCode || found.type == AVMetadataObjectTypeCode39Code || found.type == AVMetadataObjectTypeCode93Code || found.type == AVMetadataObjectTypeCode128Code || found.type == AVMetadataObjectTypeDataMatrixCode || found.type == AVMetadataObjectTypeEAN8Code || found.type == AVMetadataObjectTypeEAN13Code) && found.stringValue != nil {
            scanning = false
