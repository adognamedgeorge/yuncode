import {Component, Input, Output, ViewChild, EventEmitter, ElementRef, Renderer2} from '@angular/core';
...
/**
 * Generated class for the MinishopShopListPage page.
 *
...
@Component({
  selector: 'page-minishop-shop-list',
  templateUrl: 'minishop-shop-list.html',
})
export class MinishopShopListPage {
  ...
  addProduct(item, shopCart, e) {
    ...
    if (this.token.length > 0) {
      if (!shopCart[item['id']]) {
        ...
        item['quantity'] = shopCart[item['id']]['inCartQuantity']
      }
